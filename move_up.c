...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/06/26 18:30:15 by kkah-wen          #+#    #+#             */
/*   Updated: 2023/06/27 17:48:27 by kkah-wen         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	print_frame_up(t_game *game)
{
	...
	{
		if (i >= 0 && i < SPEED)
			draw_charfr(game, game->up_a.frame0);
		else if (i >= SPEED && i < (SPEED * 2))
			draw_charfr(game, game->up_a.frame1);
		else if (i >= SPEED * 2 && i < (SPEED * 3))
			draw_charfr(game, game->up_a.frame2);
		else if (i >= SPEED * 3 && i < (SPEED * 4))
			draw_charfr(game, game->up_a.frame1);
	}
	else if (!game->moving)
		draw_charfr(game, game->character_u.ptr);
}
